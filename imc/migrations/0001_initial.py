...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Movie'
        db.create_table('imc_movie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, db_index=True)),
            ('added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile'])),
            ('is_current', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('index', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True)),
            ...
            ('imdb_link', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
