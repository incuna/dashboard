...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.added_by'
        db.add_column('shoppinglist_item', 'added_by', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['profiles.Profile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Item.added_by'
        db.delete_column('shoppinglist_item', 'added_by_id')
