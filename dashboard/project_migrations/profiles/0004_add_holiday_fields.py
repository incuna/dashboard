...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_profile', 'holiday_per_annum',
                      self.gf('django.db.models.fields.IntegerField')(default=20),
                      keep_default=False)

        # Adding field 'Profile.start_date'
        db.add_column('profiles_profile', 'start_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Profile.end_date'
        db.add_column('profiles_profile', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.manager'
        db.add_column('profiles_profile', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='managed_employees', null=True, to=orm['profiles.Profile']),
                      keep_default=False)
