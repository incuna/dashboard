...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Movie.index'
        db.add_column('imc_movie', 'index', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Movie.index'
        db.delete_column('imc_movie', 'index')
