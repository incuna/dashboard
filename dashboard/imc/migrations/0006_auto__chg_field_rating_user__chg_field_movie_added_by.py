...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('imc_rating', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile']))

        # Changing field 'Movie.added_by'
        db.alter_column('imc_movie', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['profiles.Profile']))


    def backwards(self, orm):
        
        # Changing field 'Rating.user'
        db.alter_column('imc_rating', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))

        # Changing field 'Movie.added_by'
        db.alter_column('imc_movie', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
