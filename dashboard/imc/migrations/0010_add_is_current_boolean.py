...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Movie.is_current'
        db.add_column('imc_movie', 'is_current', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Movie.is_current'
        db.delete_column('imc_movie', 'is_current')
