...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Rating.user'
        db.alter_column('imc_rating', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imc.FilmBuff']))

        # Changing field 'Movie.added_by'
        db.alter_column('imc_movie', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imc.FilmBuff']))
