...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Movie.updated'
        db.delete_column(u'movies', 'updated')

        # Deleting field 'Movie.created'
        db.delete_column(u'movies', 'created')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Movie.updated'
        raise RuntimeError("Cannot reverse this migration. 'Movie.updated' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Movie.created'
        raise RuntimeError("Cannot reverse this migration. 'Movie.created' and its values cannot be restored.")
