...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserRating', fields ['movie', 'user']
        db.create_unique('imc_userrating', ['movie_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserRating', fields ['movie', 'user']
        db.delete_unique('imc_userrating', ['movie_id', 'user_id'])
    ...
    models = {
        ...
        'imc.userrating': {
            'Meta': {'unique_together': "(('user', 'movie'),)", 'object_name': 'UserRating'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
