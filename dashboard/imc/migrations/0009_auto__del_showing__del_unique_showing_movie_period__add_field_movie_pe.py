...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Movie.period'
        db.add_column('imc_movie', 'period', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['imc.Period'], unique=True, null=True, blank=True), keep_default=False)

        # Changing field 'Movie.slug'
        db.alter_column('imc_movie', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=255))

        # Adding index on 'Movie', fields ['slug']
        db.create_index('imc_movie', ['slug'])


    def backwards(self, orm):
        
        # Removing index on 'Movie', fields ['slug']
        db.delete_index('imc_movie', ['slug'])
        ...
        # Deleting field 'Movie.period'
        db.delete_column('imc_movie', 'period_id')

        # Changing field 'Movie.slug'
        db.alter_column('imc_movie', 'slug', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'imc.movie': {
            ...
            'period': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['imc.Period']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
