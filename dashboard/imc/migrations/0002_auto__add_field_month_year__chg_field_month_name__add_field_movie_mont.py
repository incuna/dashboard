...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Month.year'
        db.add_column('imc_month', 'year', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Month.name'
        db.alter_column('imc_month', 'name', self.gf('django.db.models.fields.IntegerField')())

        # Adding field 'Movie.month'
        db.add_column(u'movies', 'month', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['imc.Month']), keep_default=False)

        # Changing field 'Movie.added_by'
        db.alter_column(u'movies', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['imc.FilmBuff']))


    def backwards(self, orm):
        
        # Deleting field 'Month.year'
        db.delete_column('imc_month', 'year')

        # Changing field 'Month.name'
        db.alter_column('imc_month', 'name', self.gf('django.db.models.fields.CharField')(max_length=9))

        # Deleting field 'Movie.month'
        db.delete_column(u'movies', 'month_id')

        # Changing field 'Movie.added_by'
        db.alter_column(u'movies', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'imc.movie': {
            ...
            'month': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['imc.Month']"}),
